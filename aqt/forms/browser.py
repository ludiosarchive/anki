...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/find.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/view-pim-calendar.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReschedule.setIcon(icon1)
        self.actionReschedule.setObjectName(_fromUtf8("actionReschedule"))
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/edit-undo.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/document-preview.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFind.setIcon(icon3)
        self.actionFind.setObjectName(_fromUtf8("actionFind"))
        self.actionNote = QtGui.QAction(Dialog)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/Anki_Fact.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionNextCard.setObjectName(_fromUtf8("actionNextCard"))
        self.actionPreviousCard = QtGui.QAction(Dialog)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/go-previous.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPreviousCard.setIcon(icon6)
        self.actionPreviousCard.setObjectName(_fromUtf8("actionPreviousCard"))
        ...
        self.actionGuide.setIcon(icon7)
        self.actionGuide.setObjectName(_fromUtf8("actionGuide"))
        self.actionChangeModel = QtGui.QAction(Dialog)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/system-software-update.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionChangeModel.setIcon(icon8)
        self.actionChangeModel.setObjectName(_fromUtf8("actionChangeModel"))
        self.actionSelectNotes = QtGui.QAction(Dialog)
        self.actionSelectNotes.setObjectName(_fromUtf8("actionSelectNotes"))
        self.actionFindReplace = QtGui.QAction(Dialog)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/edit-find-replace.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionCram.setObjectName(_fromUtf8("actionCram"))
        self.actionTags = QtGui.QAction(Dialog)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/anki-tag.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionTags.setIcon(icon10)
        self.actionTags.setObjectName(_fromUtf8("actionTags"))
        self.actionCardList = QtGui.QAction(Dialog)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/generate_07.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCardList.setIcon(icon11)
        self.actionCardList.setObjectName(_fromUtf8("actionCardList"))
        self.actionFindDuplicates = QtGui.QAction(Dialog)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/edit-find 2.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/view-sort-ascending.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReposition.setIcon(icon13)
        self.actionReposition.setObjectName(_fromUtf8("actionReposition"))
        self.actionFirstCard = QtGui.QAction(Dialog)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/arrow-up.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFirstCard.setIcon(icon14)
        self.actionFirstCard.setObjectName(_fromUtf8("actionFirstCard"))
        self.actionLastCard = QtGui.QAction(Dialog)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/arrow-down.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionLastCard.setIcon(icon15)
        self.actionLastCard.setObjectName(_fromUtf8("actionLastCard"))
        ...
        QtCore.QObject.connect(self.actionSelectAll, QtCore.SIGNAL(_fromUtf8("triggered()")), self.tableView.selectAll)
        QtCore.QObject.connect(self.actionClose, QtCore.SIGNAL(_fromUtf8("activated()")), Dialog.close)
