...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        Preferences.setTabOrder(self.preventEdits, self.saveWhenClosing)
        ...
        Preferences.setTabOrder(self.showStudyOptions, self.addZeroSpace)
        Preferences.setTabOrder(self.addZeroSpace, self.buttonBox)
