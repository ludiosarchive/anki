...
class Ui_Preferences(object):
    def setupUi(self, Preferences):
        ...
        self.autoplaySounds = QtGui.QCheckBox(self.tab_1)
        self.autoplaySounds.setObjectName("autoplaySounds")
        self.verticalLayout.addWidget(self.autoplaySounds)
        self.label_6 = QtGui.QLabel(self.tab_1)
        self.label_6.setObjectName("label_6")
        self.verticalLayout.addWidget(self.label_6)
        self.mediaChoice = QtGui.QComboBox(self.tab_1)
        self.mediaChoice.setObjectName("mediaChoice")
        self.verticalLayout.addWidget(self.mediaChoice)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.mediaPrefix = QtGui.QLabel(self.tab_1)
        self.mediaPrefix.setObjectName("mediaPrefix")
        self.horizontalLayout_2.addWidget(self.mediaPrefix)
        self.mediaPath = QtGui.QLineEdit(self.tab_1)
        self.mediaPath.setObjectName("mediaPath")
        self.horizontalLayout_2.addWidget(self.mediaPath)
        ...
        self.gridlayout1.addWidget(self.syncOnOpen, 2, 0, 1, 2)
        self.syncOnProgramOpen = QtGui.QCheckBox(self.tab_2)
        self.syncOnProgramOpen.setObjectName("syncOnProgramOpen")
        self.gridlayout1.addWidget(self.syncOnProgramOpen, 3, 0, 1, 2)
        self.disableWhenMoved = QtGui.QCheckBox(self.tab_2)
        self.disableWhenMoved.setObjectName("disableWhenMoved")
        self.gridlayout1.addWidget(self.disableWhenMoved, 4, 0, 1, 2)
        ...
        self.gridlayout2.addWidget(self.showTimer, 4, 0, 1, 1)
        self.alternativeTheme = QtGui.QCheckBox(self.tab_3)
        self.alternativeTheme.setObjectName("alternativeTheme")
        self.gridlayout2.addWidget(self.alternativeTheme, 2, 0, 1, 1)
        ...
        self.gridlayout2.addWidget(self.showTray, 5, 0, 1, 1)
        ...
        self.gridlayout2.addWidget(self.openLastDeck, 8, 0, 1, 1)
        self.deckBrowserOrder = QtGui.QCheckBox(self.tab_3)
        self.deckBrowserOrder.setObjectName("deckBrowserOrder")
        self.gridlayout2.addWidget(self.deckBrowserOrder, 9, 0, 1, 1)
        ...
        self.gridlayout2.addWidget(self.colourTimes, 3, 0, 1, 1)
        self.stripHTML = QtGui.QCheckBox(self.tab_3)
        self.stripHTML.setObjectName("stripHTML")
        self.gridlayout2.addWidget(self.stripHTML, 6, 0, 1, 1)
        self.optimizeSmall = QtGui.QCheckBox(self.tab_3)
        self.optimizeSmall.setObjectName("optimizeSmall")
        self.gridlayout2.addWidget(self.optimizeSmall, 10, 0, 1, 1)
        ...
        Preferences.setTabOrder(self.preventEdits, self.autoplaySounds)
        Preferences.setTabOrder(self.autoplaySounds, self.mediaChoice)
        Preferences.setTabOrder(self.mediaChoice, self.mediaPath)
        Preferences.setTabOrder(self.mediaPath, self.syncUser)
        Preferences.setTabOrder(self.syncUser, self.syncPass)
        Preferences.setTabOrder(self.syncPass, self.syncOnOpen)
        Preferences.setTabOrder(self.syncOnOpen, self.syncOnProgramOpen)
        Preferences.setTabOrder(self.syncOnProgramOpen, self.disableWhenMoved)
        Preferences.setTabOrder(self.disableWhenMoved, self.proxyHost)
        ...
        Preferences.setTabOrder(self.showTray, self.stripHTML)
        Preferences.setTabOrder(self.stripHTML, self.showStudyOptions)
        ...
        Preferences.setTabOrder(self.deckBrowserOrder, self.optimizeSmall)
        Preferences.setTabOrder(self.optimizeSmall, self.deleteMedia)
    ...
    def retranslateUi(self, Preferences):
        ...
        self.label.setText(_("<b>Language</b>"))
        self.label_2.setText(_("<b>Reviewing</b>"))
        ...
        self.label_6.setText(_("<b>Media</b>"))
        self.mediaPrefix.setText(_("Prefix:"))
        ...
        self.label_16.setText(_("<b>Synchronisation</b><a href=\"http://anki.ichi2.net/\"><br>Create a free account</a>."))
        self.label_18.setText(_("Password"))
        self.label_17.setText(_("Username"))
        self.syncOnOpen.setText(_("Sync on deck open/close"))
        self.syncOnProgramOpen.setText(_("Sync on program open/close"))
        self.disableWhenMoved.setText(_("Disable sync when deck moved"))
        self.label_13.setText(_("<b>Proxy</b>"))
        ...
        self.label_4.setText(_("<b>Autosaving</b>"))
        ...
        self.label_9.setText(_("<b>Backups</b><br>Decks are backed up when they are opened or synchronised, and only if they have been modified since the last backup."))
        ...
        self.optimizeSmall.setText(_("Optimize for small screens"))
