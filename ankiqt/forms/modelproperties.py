...
class Ui_ModelProperties(object):
    def setupUi(self, ModelProperties):
        ...
        self._3.addWidget(self.questionInAnswer,3,1,1,1)
        ...
        self._3.addWidget(self.allowEmptyAnswer,4,1,1,1)
    ...
    def retranslateUi(self, ModelProperties):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _("Model && Fields"))
