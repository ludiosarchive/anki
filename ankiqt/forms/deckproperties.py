...
class Ui_DeckProperties(object):
    ...
    def retranslateUi(self, DeckProperties):
        ...
        self.label_21.setText(_("<h1>Very high priority</h1>A comma-separated list of tags to prioritize. Any matching cards will be displayed before anything else, regardless of whether they have been seen before."))
        self.label_17.setText(_("<h1>High priority</h1>Matching previously seen cards will be shown before other previously seen cards. Matching new cards will be displayed before other new cards."))
        self.label_24.setText(_("<h1>Low priority</h1>A comma-separated list of tags to deprioritize. Matching cards will be shown after all other cards have been seen."))
