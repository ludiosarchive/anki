...
class Ui_DeckProperties(object):
    def setupUi(self, DeckProperties):
        ...
        self.tab.setGeometry(QtCore.QRect(0,0,501,493))
        ...
        self.tab_4.setGeometry(QtCore.QRect(0,0,501,493))
        ...
        self.tab_2.setGeometry(QtCore.QRect(0,0,501,493))
        ...
        self.tab_3.setGeometry(QtCore.QRect(0,0,501,493))
    ...
    def retranslateUi(self, DeckProperties):
        ...
        self.label_16.setText(_("<h1>Priorities</h1>A comma-separated list of tags to prioritize or deprioritize<a href=\"http://ichi2.net/anki/wiki/Priorities\">?</a>"))
