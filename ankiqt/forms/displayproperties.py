...
class Ui_DisplayProperties(object):
    def setupUi(self, DisplayProperties):
        ...
        DisplayProperties.resize(794,700)
        ...
        self.helpButton = QtGui.QPushButton(self.groupBox)
        self.helpButton.setAutoDefault(False)
        self.helpButton.setObjectName("helpButton")
        self.horizontalLayout.addWidget(self.helpButton)
        self.preview = QtGui.QPushButton(self.groupBox)
        ...
        self.vboxlayout4.addLayout(self.horizontalLayout)
        ...
        DisplayProperties.setTabOrder(self.fontSizeEdit,self.question)
